...
from ml_surrogates.gnn.gnn_io import (
    split_into_subsets_with_bootstrapping,
    split_into_subsets,
    collate_fn,
    save_dataloader,
    save_dataloader_params,
)
from ml_surrogates.gnn.models.point_net_transf_gat import PointNetTransfGAT
from ml_surrogates.gnn.models.gcn import GCN, GCN2
from ml_surrogates.gnn.models.gat import GAT
from ml_surrogates.gnn.models.trans_conv import TransConv
from ml_surrogates.gnn.models.trans_encoder import TransEncoder
from ml_surrogates.gnn.models.pnc import PNC
from ml_surrogates.gnn.models.fc_nn import FC_NN
from ml_surrogates.gnn.models.eign import EIGNLaplacianConv
from ml_surrogates.gnn.models.graphSAGE import GraphSAGE
from ml_surrogates.gnn.models.xgboost import XGBoostModel
...
def get_paths(
    ...
    model_save_to = os.path.join("/mnt/slow2/ml_surrogates", model_save_path)

...
sim_input_paths = [
    ...
    / "raw_data"
    / "exp_dist_not_connected_5k"
    / "output_networks_2000",
    get_root()
    / "data"
    / "raw_data"
    / "exp_dist_not_connected_5k"
    / "output_networks_3000",
    get_root()
    / "data"
    / "raw_data"
    / "exp_dist_not_connected_5k"
    / "output_networks_4000",
    get_root()
    / "data"
    / "raw_data"
    / "exp_dist_not_connected_5k"
...
result_path = get_root() / "data" / "train_data" / "edge_features_with_net_flow"
...
basecase_stats_path = (
    get_root() / "data" / "links_and_stats" / "pop_1pct_basecase_average_mode_stats.csv"
)
...
def process_result_dic_eign(
    ...
    edge_index, base_features, edge_is_directed_base = aggregated_data
